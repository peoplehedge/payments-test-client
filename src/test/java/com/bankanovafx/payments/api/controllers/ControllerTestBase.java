...
import com.bankanovafx.payments.api.PaymentsAPIClient;
import com.bankanovafx.payments.api.testing.HttpCallBackCatcher;
...
public class ControllerTestBase {
    ...
    private static PaymentsAPIClient client;
     ...
     * @return
     */
    protected static PaymentsAPIClient getClient() {
        if (client == null) {
            synchronized (clientSync) {
                if (client == null) {
                    client = new PaymentsAPIClient();
                }
            }
        }
        return client;
